...
export const Navbar = ({ hideInputs }: NavbarProps) => {
  const {
    searchQuery,
    setSearchQuery,
    handleSearch,
  ...
  return (
    <header className="bg-white shadow-md z-50 mt-8">
          ...
          {!hideInputs && (
            <div className="flex gap-2 flex-1 min-w-0 justify-end">
              ...
              <button
                ...
                className="shrink-0 flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 md:w-auto md:px-5 md:py-2.5 bg-blue-100 hover:bg-blue-200 rounded-full transition-colors cursor-pointer"
                title="Filters"
              >
